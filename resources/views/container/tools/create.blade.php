        ...
        <div class="mb-6">
            <div class="text-sm breadcrumbs text-gray-600 mb-2">
                <ul>
                    ...
                    <li class="text-gray-900">Nueva Herramienta</li>
                </ul>
            </div>
            <h1 class="text-3xl font-bold text-gray-900">Agregar Nueva Herramienta</h1>
            <p class="text-gray-600 mt-1">Complete el formulario para registrar una nueva herramienta en el inventario</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            ...
            <form action="{{ route('tools.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="form-control">
                    ...
                    <label class="label">
                        <span class="label-text-alt text-gray-600">Ingrese un nombre descriptivo para la herramienta</span>
                    </label>
                </div>
                ...
                <div class="form-control">
                    ...
                    <label class="label">
                        <span class="label-text-alt text-gray-600">Seleccione el estado actual de la herramienta</span>
                    </label>
                </div>
